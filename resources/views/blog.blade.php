...
<body>
    <div class="bg-white">
        ...
        <header x-data="{ menuOpen: false }" class="absolute inset-x-0 top-0 z-50 mx-auto max-w-screen-xl">
            ...
            <div x-show="menuOpen" x-transition:enter="transition ease-out duration-200" class="lg:hidden"
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
                aria-hidden="true">
                <div class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#5dffa6] to-[#15ff00] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
